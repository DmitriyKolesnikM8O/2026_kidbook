...
Принятие решения — это не одномоментный акт воли, а технологический процесс. Когда проблема структурирована, необходимо выбрать оптимальный путь её устранения. Использование формальных моделей позволяет минимизировать влияние «человеческого фактора» — страха, предвзятости и ограниченности воображения.
...
1. **Ядро**: В центре — четко сформулированный *Problem Statement*.
...
* **Черная (10 мин)**: Критический фильтр. **Важно:** нельзя просто говорить «это плохо». Нужно говорить «здесь риск потери данных, потому что...».
...
## 5. Когнитивные ловушки при выборе моделей

При поиске решения мозг склонен срезать углы. Модели помогают избежать следующих ловушек:

* **Ловушка доступности**: Мы выбираем решение, которое первым пришло в голову (лечится Зеленой шляпой).
...
*Ресурсы: Edward de Bono "Six Thinking Hats", Michael Michalko "Thinkertoys"*
